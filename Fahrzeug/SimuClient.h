...
SIMUCLIENT_API bool bInitialisiereGrafik(int iFenstergroesseX,
		int iFenstergroesseY, const char *adresse = "127.0.0.1",
...
SIMUCLIENT_API bool bZeichneStrasse(const std::string &nameHinweg,
		const std::string &nameRueckweg, int iLaenge, int iAnzahlKoordinaten,
...
SIMUCLIENT_API bool bZeichneStrasse(const char *nameHinweg,
		const char *nameRueckweg, int iLaenge, int iAnzahlKoordinaten,
		int *pFeldKoordinaten);
SIMUCLIENT_API bool bZeichneStrasse(const std::string &nameHinweg,
		const char *nameRueckweg, int iLaenge, int iAnzahlKoordinaten,
		int *pFeldKoordinaten);
...
SIMUCLIENT_API bool bZeichnePKW(const char *namePKW, const char *nameWeg,
		double dRelPosition, double dGeschwindigkeit, double dTankinhalt);
...
SIMUCLIENT_API bool bZeichneFahrrad(const std::string &nameFahrrad,
		const char *nameWeg, double dRelPosition, double dGeschwindigkeit);
